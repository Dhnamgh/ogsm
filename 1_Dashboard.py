...
Includes 100% Stacked Bar Charts by Period & Real-time Target Year.
"""
...
def create_stacked_kpi_by_unit_chart(df: pd.DataFrame, current_year_only: bool = False) -> go.Figure:
    ...
    - current_year_only = False: Biểu đồ giai đoạn 2025–2029
    - current_year_only = True: Biểu đồ tính đến năm hiện hành dựa theo cột Target_Year
    """
