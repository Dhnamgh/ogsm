...
Hỗ trợ Khối Bộ môn thử nghiệm & 29 Đơn vị chính thức.
"""
...
try:
    ...
    if not df_all.empty:
        ...
        st.caption(f"Đã nạp thành công **{len(loaded_units)} Đơn vị / Bộ môn** vào hệ thống.")

        # DANH SÁCH KHỐI BAO GỒM KHỐI BỘ MÔN
        GROUPS_LIST = [
            "Tất cả đơn vị",
