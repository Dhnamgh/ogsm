...
# Bộ CSS chuẩn hóa giao diện: Sidebar Hover & Active xanh, Banner ôm sát chữ, Nút bấm bo góc
st.markdown("""
<style>
    /* 1. TÙY CHỈNH SIDEBAR KHUNG TRÁI */
    ...
    /* 2. STYLE BANNER TIÊU ĐỀ ÔM SÁT CHỮ */
    .main-banner-blue {
    ...
    /* 3. NÚT CHỌN KHỐI (RADIO NẰM NGANG CÓ HOVER XANH) */
